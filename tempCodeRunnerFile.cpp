...
void buildhero(){
    ...
    try{
        idhero = inputIntRangeThrow("ID Hero",1,jumlahHero);
    }catch(exception &e){
    ...
    if(indexHero == -1){
        cout << merah << "Hero tidak ditemukan!\n" << reset;
        pause();
        return;
    }

    baru.namaHero = hero[indexHero].nama;
    baru.role     = hero[indexHero].detail.role;

    cout << "PILIH SPELL HERO\n";
    lihatSpell();
    cout << "Masukkan ID Spell : ";

    int idSpell;

    try{
        idSpell = inputIntRangeThrow("ID Spell",1,jumlahSpell);
    }catch(exception &e){
        cout << merah << "\nError: " << e.what() << reset << endl;
        pause();
        return;
    }
    baru.spell = spell[idSpell - 1].nama;
    cout << "PILIH EMBLEM HERO \n";
    lihatEmblem();
    cout << "Masukkan ID Emblem : ";
    int idEmblem;
    try{
        idEmblem = inputIntRangeThrow("ID Emblem",1,jumlahEmblem);
    }catch(exception &e){
        cout << merah << "\nError: " << e.what() << reset << endl;
        pause();
        return;
    }
    baru.emblem = emblem[idEmblem - 1].nama;
    buildList[jumlahBuild++] = baru;
    system("cls");
    cout << "========================================\n"
         << "|      BUILD HERO BERHASIL DIBUAT!     |\n"
         << "========================================\n";
    cout << "Hero   : " << baru.namaHero << endl;
    cout << "Role   : " << baru.role << endl;
    cout << "Spell  : " << baru.spell << endl;
    cout << "Emblem : " << baru.emblem << endl;
    pause();
}
...
void lihatBuildHero(){
    ...
    system("cls");
    cout << "=====================================================================\n";
    cout << "| No | Hero            | Role        | Spell        | Emblem       |\n";
    cout << "=====================================================================\n";
    for(int i = 0; i < jumlahBuild; i++){
        cout << setw(4) << buildList[i].id << " "
             << setw(15) << buildList[i].namaHero << " "
             << setw(12) << buildList[i].role << " "
             << setw(12) << buildList[i].spell << " "
             << setw(12) << buildList[i].emblem << endl;
    }
    cout << "=====================================================================\n";
    pause();
}
...
void menuBuild(){
    ...
    do{
        system("cls");
        cout << "===================================================================\n";
        cout << "|                      MENU BUILD HERO                             |\n";
        cout << "===================================================================\n";
        cout << "| 1. Buat Build Hero                                              |\n";
        cout << "| 2. Lihat Semua Build                                            |\n";
        cout << "| 3. Kembali ke Menu User                                         |\n";
        cout << "===================================================================\n";
        cout << "Pilih : ";
        cin >> pilih;
        clearBuffer();
        switch(pilih){
            ...
            case 3:
                system("cls");
                pesan("Build Hero", "Kembali ke Menu User");
                pause();
                break;
            default:
...
void menuUser(){
    ...
    do{
        ...
        cout << hijau << bold << "+-------------------------------------------+\n"
             ...
             << "|4. Build hero" << (pilihan == 4 ? " <" : " ") << "                             |\n"
             << "|5. Compare Hero" << (pilihan == 5 ? " <" : "  ") << "                          |\n"
             << "|6. Hero Favorit" << (pilihan == 6 ? " <" : "  ") << "                          |\n"
             << "|7. Keluar" << (pilihan == 7 ? " <" : "  ") << "                                |\n"
             << "+-------------------------------------------+\n";
        cout << kuning << bold << "Gunakan Panah Atas/Bawah, Enter untuk pilih."<< reset << endl;
        tombol = _getch();
